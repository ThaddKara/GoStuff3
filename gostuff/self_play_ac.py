...
def main():
    ...
    parser.add_argument('--learning-agent', default='ac_v1.h5')
    parser.add_argument('--num-games', '-n', type=int, default=10)
    parser.add_argument('--game-log-out', default='chapter_10_rl/log_0001.txt')
    parser.add_argument('--experience-out', default='chapter_10_rl/exp_0001.h5')
