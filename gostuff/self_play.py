...
def main():
    ...
    parser.add_argument('--learning-agent', default='agents/deep_bot.h5')
    parser.add_argument('--num-games', '-n', type=int, default=10)
    parser.add_argument('--game-log-out', default='chapter_10_rl/log.txt')
    parser.add_argument('--experience-out', default='chapter_10_rl/experience.h5')
